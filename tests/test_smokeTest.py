...
class TestSmokeTest():
  ...
  def test_test4JoinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Rawin")
    self.driver.find_element(By.NAME, "lname").send_keys("Olivera")
    self.driver.find_element(By.NAME, "bizname").send_keys("Software Up")
